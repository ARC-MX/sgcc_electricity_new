...
class SensorUpdator:
    ...
    def update_one_userid(self, user_id: str, balance: float, last_daily_date: str, last_daily_usage: float, yearly_usage: float, yearly_charge: float, month_charge: float, month_usage: float):
